    ...
    <section id="stories" ref="storiesRef">
      ...
      <div class="container" ref="storiesContainerRef">
        <div class="slider" ref="slider">
                ...
                <div class="slider-btn-group">
                  ...
                  >
                    ...
                    >
                      ...
                      />
                      <path
                        d="M11 6C11 6 5 10.4189 5 12C5 13.5812 11 18 11 18"
                        stroke="#FCFCFC"
                        stroke-width="1.5"
                        stroke-linecap="round"
                        stroke-linejoin="round"
                  ...
                  <div class="slider-pagination">
                    <span
                      v-for="(_, i) in Math.min(slides.length, sliderLimit)"
                      :key="i"
                      class="nav"
                      :class="{ active: i + 1 === activeSlide }"
                      @click="goToSlide(i)"
                  ...
                  >
                    ...
                    >
                      ...
                      />
                      <path
                        d="M13 6C13 6 19 10.4189 19 12C19 13.5812 13 18 13 18"
                        stroke="#FCFCFC"
                        stroke-width="1.5"
                        stroke-linecap="round"
                        stroke-linejoin="round"
          ...
          <div
            class="slider-btn-group mobile-view"
            role="region"
          ...
          >
            ...
            <button
              ...
              :aria-disabled="currentIndex === slides.length - 1"
            >
              <svg
                width="24"
                height="24"
