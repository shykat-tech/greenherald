<template>
  <section id="upcoming-events" ref="upcomingEventsRef">
    <div class="main-container" ref="mainContainerRef">
      <h1 class="heading font-heading">Upcoming events</h1>
        ...
        <div class="content">
          ...
          <div class="event-details">
            ...
            <div class="title">
              ...
              <span
                >Relive the yearbook memories, reconnect with classmates, and
            ...
            <div class="btn-group">
              <CommonPrimaryButton
                @click="globalStore.openModal('alumniConfirmation')"
                >Register Now</CommonPrimaryButton
              >
              <button class="details-btn">
                ...
                <div class="btn-icon-container">
                  ...
                  >
                    ...
                    />
                    <path
                      d="M10.8325 15C10.8325 15 15.8325 11.3176 15.8325 10C15.8325 8.68233 10.8325 5 10.8325 5"
                      stroke="#08110B"
                      stroke-width="1.5"
                      stroke-linecap="round"
                      stroke-linejoin="round"
...
const date = "2025-11-30T00:00:00";
